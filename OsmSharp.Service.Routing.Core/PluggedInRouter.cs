...
{
    /// <summary>
    /// An implementation of the IPluggedInRouter that acts as a wrapper around the default Router class.
    /// </summary>
    public class PluggedInRouter : IPluggedInRouter
    {
        /// <summary>
        /// Holds the router.
        /// </summary>
        ...
        public PluggedInRouter(Router router)
        {
            _router = router;
        }
